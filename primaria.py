...
r = urllib.request.urlopen('https://raw.githubusercontent.com/alexmagno6m/render/main/BD_PRIMARIA_2024.csv')
...
app.layout = html.Div([
    ...
    html.Div([
        "PA: Bloques de Permanencia, por asignar a Clase o TP; HE: Horas extras"
    ]),
    html.Div([
